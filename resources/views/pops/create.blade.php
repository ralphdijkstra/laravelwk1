...
@section('content')
    <form class="grid place-items-center w-11/12 lg:w-3/4 xl:w-1/2 m-auto my-5 p-5 bg-gray-100 rounded" action="/pops" method="POST">
        @csrf
        ...
        <br>
        <button class="w-1/2 md:w-1/3 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" type="submit">Create new pop</button>
    </form>
    <div id="info"></div>
@endsection
