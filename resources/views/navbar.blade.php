            ...
            <div class="flex justify-between">
                <div class="flex space-x-7">
                    ...
                    <div class="hidden md:flex items-center space-x-5 text-xl">
                        ...
                        <a href="" class="py-4 px-2 text-black font-semibold hover:text-red-500 transition duration-300">Services</a>
                        <a href="" class="py-4 px-2 text-black font-semibold hover:text-red-500 transition duration-300">About</a>
                        <a href="" class="py-4 px-2 text-black font-semibold hover:text-red-500 transition duration-300">Contact Us</a>
                    </div>
                </div>
                <!-- Mobile menu button -->
